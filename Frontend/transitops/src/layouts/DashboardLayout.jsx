...
import { Bell, LogOut, Menu, Moon, Sun, X, Truck } from 'lucide-react'
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-800 px-5 py-5">
            <div className="flex items-center gap-3">
              <div className="rounded-xl bg-emerald-500/15 p-2 text-emerald-400 shadow-sm shadow-emerald-500/10 ring-1 ring-emerald-500/20">
                <Truck size={20} />
              </div>
              <div>
